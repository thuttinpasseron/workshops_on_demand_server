...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("workshops", [
      ...
      {
        name: "RUST 101 Introduction to the Rust programmimg language",
      ...
      {
        name: "ML Pipeline with KubeDirector​",
      ...
      {
        name: "Deploying end-to-end machine learning workflows​",
        notebook: "WKSHP-ML-KUB",
        description: "The ",
        capacity: 54,
        priority: 1,
